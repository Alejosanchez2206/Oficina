...
const apiUrl = 'http://localhost:5000/api/modulos';
...
form.onsubmit = async function (e) {
    ...
    const formData = {
        ...
        UndFuncional: document.getElementById('unfuncional').value,
    ...
    try {
        let url = apiUrl;
        let method = 'POST';
        let successMessage = 'Módulo creado exitosamente';
...
function editarModulo(modulo) {
    ...
    document.getElementById('unfuncional').value = modulo.UndFuncional;
